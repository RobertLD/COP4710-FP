...
VALUES
  ("Akeem","OYT28FST9LL",0),
  ("Julian","OJN85RTF8NS",1),
  ("Kasper","TCQ41CXY4VZ",0),
  ("Ainsley","HSS47ETB1OR",1),
  ("McKenzie","EJT45MOR3TM",0),
  ("Timon","LBY25OEQ7GL",0),
  ("Thaddeus","WJD88RGF8WV",0),
  ("Minerva","TTI66WJP0CH",1),
  ("Amos","CUX13RFF2NL",0),
  ("Kyra","MPB50KLD3QY",0);
INSERT INTO `user` (`username`,`password_hash`,`tmp_password`)
VALUES
  ("Scott","MNO87RQF5TS",0),
  ("Blossom","NSU15QCG8RP",0),
  ("Jordan","VYB12RLP5OX",1),
  ("Alexander","RFV83QHQ8BJ",1),
  ("Zia","PDO73JTE2YZ",0),
  ("Lois","KMP28GXM8RC",0),
  ("Alexander","YIH40SVS2PJ",1),
  ("Quinn","PXF53OXT0CP",1),
  ("Eagan","SPL26DTL6HV",0),
  ("Alden","IGD53CFG8FJ",1);
INSERT INTO `user` (`username`,`password_hash`,`tmp_password`)
VALUES
  ("Lewis","HMC87UJC5DB",1),
  ("Anne","KDK87LLD2KO",0),
  ("Preston","UDU13VMM7LP",0),
  ("Halla","OLP26UKL8PY",1),
  ("Ezekiel","UWY47SAX4AU",1),
  ("Debra","XYD92CUM5DZ",1),
  ("Ahmed","CKH91NPC1AW",1),
  ("Grant","HXR17TLY7RD",1),
  ("Olga","LHG65RWE5LR",0),
...
VALUES
  ...
  ("Macon","MWY22VLE4BR",1),
  ("Jenna","TTE42GIQ7FD",1),
  ("Richard","RUW33TMC6SP",1),
  ("Jana","SZS52PRN5SJ",0),
  ("David","JGL22RZI4UV",0),
  ("Amelia","OFF92VWK1JH",0),
  ("Rahim","PMU73BTX8OB",1),
  ("Myles","UQF78JPK8MV",0),
  ("Ishmael","HVE77EKN7IY",0);
INSERT INTO `user` (`username`,`password_hash`,`tmp_password`)
VALUES
  ("Basil","XAX67URO5OZ",0),
  ("Oprah","PGM58WLR4DB",0),
  ("Eric","JPR81FFB7PY",0),
  ("Dara","KAC71KZI3JQ",0),
  ("Thomas","LEF97UYT2JF",0),
  ("Brooke","WQU80FZX1BM",1),
  ("Joelle","DZB73MRC3OH",0),
  ("McKenzie","NPM26HTP6HX",1),
  ("Tallulah","HRJ23MPB7JG",1),
  ("Jillian","GDH36FIT6RJ",0);
INSERT INTO `user` (`username`,`password_hash`,`tmp_password`)
VALUES
  ("Scott","LUH25PQV1UI",0),
  ("Walter","HOG93OQR7XL",0),
  ("Kimberly","NXG12NWE9HJ",0),
  ("Erin","PSJ45YPC2FO",0),
  ("Ferdinand","WRH42PZB1QK",1),
  ("Marshall","TDO05MTO3TN",0),
  ("Bruno","ZRK22TCX3OW",1),
  ("Bernard","WIS46BLT4MR",0),
  ("Lavinia","YYU18IIF5JP",1),
  ("Edan","THO93MFN7BK",1);
INSERT INTO `user` (`username`,`password_hash`,`tmp_password`)
VALUES
  ("Mason","NTW36GHB9JA",0),
  ("Sophia","QHU55CUG6NM",0),
  ("Rhona","ADJ97HZF1IL",1),
  ("Bree","RUY34SDJ0TS",0),
  ("Kareem","CES85QNW0OC",0),
  ("Irene","TSC83RUH7NO",0),
  ("Asher","KGF10XXS6IS",1),
  ("Tarik","PFV72EBM8UP",0),
  ("Nathan","HPE85RHL2VY",1),
  ("Chase","XWP58UAW8IH",0);
INSERT INTO `user` (`username`,`password_hash`,`tmp_password`)
VALUES
  ("Steel","IHY74LDW8YJ",0),
  ("Wang","PRQ94GLT7MW",0),
  ("Lucius","QCY82DTP6MO",1),
  ("Zena","CPT13VQD4FD",0),
  ("Dylan","VUL23HDJ0CG",1),
  ("Randall","BCL28QMG3MH",1),
  ("Paula","SHI84WKT5RC",1),
  ("Erica","PIV74QQV2RD",1),
  ("Andrew","VVB84KYL1EK",0),
  ("Veda","MMB75QHR0QB",0);
INSERT INTO `user` (`username`,`password_hash`,`tmp_password`)
VALUES
  ("Xanthus","HLN52XIN3QU",1),
  ("Fritz","JFM25RGK0SM",1),
  ("Athena","PDF41YMU3IE",0),
  ("Xanthus","QTS29LIE8AJ",1),
  ("Talon","UFC83SHU8KH",1),
  ("Wesley","XUF78FXT3CD",0),
  ("Keaton","KLD73BOZ1DP",1),
  ("Angelica","TCK15NFY2BM",1),
  ("Adria","YEX59HFL3DY",1),
  ("Idona","VEF72DKT1IO",0);
INSERT INTO `user` (`username`,`password_hash`,`tmp_password`)
VALUES
  ("Ray","RYG02LOR3GJ",1),
  ("Jameson","JRL11XMR4JG",1),
  ("Ethan","QCM68JYH1ZS",0),
  ("Cairo","SZE66RQD5CE",1),
  ("Barry","HYS32BIE3JM",1),
  ("Bruno","QOW81RVR7GC",0),
  ("Steven","MBX85MBG7LP",0),
  ("Pandora","QIU48NMP4OE",1),
  ("Eagan","ISM51GUK8NB",1),
  ("Whilemina","LIO27QFW4CW",0);
  
INSERT INTO `staff` (`user_id`,`superadmin`)
VALUES
  (1,1),
  (2,1),
  (3,0),
